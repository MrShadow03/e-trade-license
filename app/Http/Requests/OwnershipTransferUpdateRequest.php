...
class OwnershipTransferUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'phone.required' => 'মোবাইল নং অবশ্যই পূরণ করতে হবে',
            'phone.max' => 'মোবাইল নং অধিকতম ১১ অক্ষর হতে পারে',
            'phone.min' => 'মোবাইল নং অবশ্যই ১১ অক্ষর হতে হবে',
            'phone.regex' => 'মোবাইল নং সঠিক নয়',
            'phone.not_in' => 'আপনি নিজের মোবাইল নং ব্যবহার করতে পারবেন না',
