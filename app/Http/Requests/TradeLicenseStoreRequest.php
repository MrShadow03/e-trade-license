...
class TradeLicenseStoreRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'zone_bn' => ['required', 'string', 'max:255', 'regex:/^[\x{0980}-\x{09FF} ]+$/u'],
            'ward_no' => ['required'],
            'tin_no' => ['required', 'regex:/^[0-9]+$/'],
            'bin_no' => ['required'],
