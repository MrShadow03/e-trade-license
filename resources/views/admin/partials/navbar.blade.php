<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-3 font-bn" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
            ...
            <img class="object-fit-cover" src="{{ Helpers::getImageUrl(auth()->user(), 'dp', 'thumb', 'admins') }}" alt="user" />
        </div>
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img class="object-fit-cover" alt="Logo" src="{{ Helpers::getImageUrl(auth()->user(), 'dp', 'thumb', 'admins') }}" />
                    </div>
                    <!--end::Avatar-->
