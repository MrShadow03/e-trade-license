                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{ asset('assets/admin/assets/media/avatars/300-20.jpg') }}"
                                                alt="img">
                                        </div>
                                        <!--end::User-->
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-1.jpg') }}"
                                            alt="img">
                                    </div>
                                    <!--end::User-->
                                </div>
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-23.jpg') }}"
                                            alt="img">
                                    </div>
                                    <!--end::User-->
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="" class="w-30px me-3"
                                            src="{{ asset('assets/admin/assets/media/svg/files/pdf.svg') }}">
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="/metronic8/demo1/../demo1/apps/projects/project.html"
                                            class="w-30px me-3"
                                            src="{{ asset('assets/admin/assets/media/svg/files/doc.svg') }}">
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        ...
                                        <img alt="/metronic8/demo1/../demo1/apps/projects/project.html"
                                            class="w-30px me-3"
                                            src="{{ asset('assets/admin/assets/media/svg/files/css.svg') }}">
                                        <!--end::Icon-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset('assets/admin/assets/media/stock/600x400/img-29.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset('assets/admin/assets/media/stock/600x400/img-31.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ asset('assets/admin/assets/media/stock/600x400/img-40.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-4.jpg') }}"
                                            alt="img">
                                    </div>
                                    <!--end::User-->
                                </div>
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                    src="{{ asset('assets/admin/assets/media/avatars/300-25.jpg') }}"></div>
                            <!--end::Avatar-->
                            <!--begin::Details-->
                            <div class="ms-3">
                ...
                <div class="d-flex justify-content-end mb-10 ">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Avatar-->
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                    src="{{ asset('assets/admin/assets/media/avatars/300-1.jpg') }}"></div>
                            <!--end::Avatar-->
                        </div>
                        <!--end::User-->
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-1.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-3.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-8.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-26.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-21.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-34.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex flex-stack">
                ...
                <!--begin::Pic-->
                <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                    <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-27.jpg') }}" alt="">
                </div>
                <!--end::Pic-->
            </div>
            <!--end::Item-->
