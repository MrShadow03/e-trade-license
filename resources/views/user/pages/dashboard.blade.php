...
<div id="kt_app_content_container" class="app-container container-fluid">
    ...
    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('{{ asset('assets/admin/assets/media/patterns/vector-1.png') }}')">
                <!--begin::Header-->
                ...
                <div class="card-body d-flex flex-column justify-content-end pe-0">
                    ...
                    <div class="symbol-group symbol-hover flex-nowrap">
                        ...
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                            <img alt="Pic" src="{{ asset('assets/admin/assets/media/avatars/300-11.jpg') }}">
                        </div>
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                        </div>
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                            <img alt="Pic" src="{{ asset('assets/admin/assets/media/avatars/300-2.jpg') }}">
                        </div>
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
                            <span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
                        </div>
                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
                            <img alt="Pic" src="{{ asset('assets/admin/assets/media/avatars/300-12.jpg') }}">
                        </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <!--begin::Subtitle-->
                        <span class="text-gray-400 pt-1 fw-semibold fs-6">Projects Earnings in
                            April</span>
                        <!--end::Subtitle-->
                    </div>
                    <!--end::Title-->
            ...
            <div class="card card-flush h-lg-50">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Section-->
                        <a href="#" class="text-primary fw-semibold fs-6 me-2">Google
                            Ads CPC</a>
                        <!--end::Section-->
        ...
        <div class="col-xxl-6">
            ...
            <div class="card card-flush h-md-100">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('{{ asset('assets/admin/assets/media/stock/900x600/42.png') }}')">
                    <!--begin::Wrapper-->
                    <div class="mb-10">
                        <!--begin::Title-->
                    ...
                    <!--begin::Illustration-->
                    <img class="mx-auto h-150px h-lg-200px  theme-light-show" alt="" src="{{ asset('assets/admin/assets/media/illustrations/misc/upgrade.svg') }}">
                    <img class="mx-auto h-150px h-lg-200px  theme-dark-show" alt="" src="{{ asset('assets/admin/assets/media/illustrations/misc/upgrade-dark.svg') }}">
                    <!--end::Illustration-->
                </div>
                <!--end::Body-->
            </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-3.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-2.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-9.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-7.jpg') }}" class="" alt="">
                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-25.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-24.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-20.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-17.jpg') }}" class="" alt="">
                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-11.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-23.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-4.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-1.jpg') }}" class="" alt="">
                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-12.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-21.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-30.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-14.jpg') }}" class="" alt="">
                                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-6.jpg') }}" class="" alt="">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-10.jpg') }}" class="" alt="">
                                                    </div>
                ...
                <div class="card-body py-9">
                    ...
                    <div class="row gx-9 h-100">
                        ...
                        <div class="col-sm-6 mb-10 mb-sm-0">
                            <!--begin::Image-->
                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('{{ asset('assets/admin/assets/media/stock/600x600/img-65.jpg') }}')">
                            </div>
                            <!--end::Image-->
                        </div>
                        <!--end::Col-->
                            ...
                            <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                        ...
                                        <div class="d-flex align-items-center me-5 me-xl-13">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <a href="pages/user-profile/overview.html" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert
                                                    Fox</a>
                                            </div>
                                            <!--end::Info-->
                                        </div>
                                ...
                                <div class="d-flex flex-stack mt-auto bd-highlight">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                            <img alt="Pic" src="{{ asset('assets/admin/assets/media/avatars/300-3.jpg') }}">
                                        </div>
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                                        </div>
            ...
            <div class="card card-flush overflow-hidden h-lg-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">1,046 Inbound Calls
                            today</span>
                    </h3>
                    <!--end::Title-->
                ...
                <div class="card-body py-0 px-0">
                    ...
                    <ul class="nav d-flex justify-content-between mb-3 mx-9">
                        ...
                        <li class="nav-item mb-3">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active" data-bs-toggle="tab" id="kt_charts_widget_35_tab_1" href="#kt_charts_widget_35_tab_content_1">
                        ...
                        <li class="nav-item mb-3">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_2" href="#kt_charts_widget_35_tab_content_2">
                        ...
                        <li class="nav-item mb-3">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_3" href="#kt_charts_widget_35_tab_content_3">
                        ...
                        <li class="nav-item mb-3">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_4" href="#kt_charts_widget_35_tab_content_4">
                        ...
                        <li class="nav-item mb-3">
                            <!--begin::Link-->
                            <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_5" href="#kt_charts_widget_35_tab_content_5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-3">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x600/img-49.jpg') }}" class="" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-3">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x600/img-40.jpg') }}" class="" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-3">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x600/img-39.jpg') }}" class="" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-3">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x600/img-47.jpg') }}" class="" alt="">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-3">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x600/img-48.jpg') }}" class="" alt="">
                                            </div>
