                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-gray-900" placeholder="" name="owner_name_bn" value="" required/> 
                        </div>
                        <!--end::Input-->
                        @error('owner_name_bn')
                        <div class="fv-plugins message-container invalid-feedback">{{ $message }}</div>
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-gray-900" placeholder="" name="owner_name" value="" required/> 
                        </div>
                        <!--end::Input-->
                        @error('owner_name')
                        <div class="fv-plugins message-container invalid-feedback">{{ $message }}</div>
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-3 col-md-4 col-12 mb-4 mb-md-0">
                        <div class="fv-row">
                            ...
                            <label class="pb-2 pb-md-0 min-h-0 fs-6 text-gray-{{ LABEL_INTENSITY }} fw-semibold mb-2">
                                <span>
                                    <span class="required">মালিকানা স্থানান্তর দলিল</span>
                                </span>
                            </label>
                            <!--end::Label-->
...
<script>
    ...
    const ownerNameBn = document.querySelector('[name="owner_name_bn"]');
    const ownerName = document.querySelector('[name="owner_name"]');
