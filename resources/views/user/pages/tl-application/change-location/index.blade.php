...
<div id="kt_app_content_container" class="app-container container-lg">
    <div class="card card-flush font-bn">
        <!--begin::Form-->
        <form class="card-body form" action="{{ route('user.trade_license_applications.change_location.store', $application->id) }}" method="POST" enctype="multipart/form-data" id="form">
            @csrf
            @method('POST')
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-gray-900" placeholder="ঠিকানা" name="address_of_business_organization_bn" value="{{ old('address_of_business_organization_bn') }}" required/> 
                        </div>
                        <!--end::Input-->
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-gray-900" placeholder="Address" name="address_of_business_organization" value="{{ old('address_of_business_organization') }}" required/>
                        </div>
                        <!--end::Input-->
                ...
                <div class="col">
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-gray-900" placeholder="অঞ্চল" name="zone_bn" value="{{ old("zone_bn") }}"/> 
                        </div>
                        <!--end::Input-->
                        @error('zone_bn')
                        <div class="fv-plugins message-container invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <div class="w-100">
                                <select type="text" class="form-control text-gray-900 form-select font-ador fw-light" name="ward_no" value="{{ $application->ward_no }}" required>
                                    ...
                                    @for ($i = 1; $i <= 30; $i++)
                                        <option value="{{ $i }}" @selected($i == old('ward_no'))>{{ Helpers::convertToBanglaDigits($i) }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
